...
WPs = {
    "L1Mu26_12": {"L1": r"$p^{\mu,L1}_{T} \geq 26$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 30$ GeV"},
    "L1Mu22_12": {"L1": r"$p^{\mu,L1}_{T} \geq 22$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 26$ GeV"},
    "L1Mu20_12": {"L1": r"$p^{\mu,L1}_{T} \geq 20$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 24$ GeV"},
    "L1Mu15_12": {"L1": r"$p^{\mu,L1}_{T} \geq 15$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 19$ GeV"},
    "L1Mu10_12": {"L1": r"$p^{\mu,L1}_{T} \geq 10$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 14$ GeV"},
    "L1Mu5_12": {"L1": r"$p^{\mu,L1}_{T} \geq 5$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 9$ GeV"},
    "L1Mu3_12": {"L1": r"$p^{\mu,L1}_{T} \geq 3$ GeV", "Reco": r"$p^{\mu,offline}_{T} \geq 7$ GeV"}
}
...
for var in vars_title:
    for tf in TFs:
        ...
        # Quality label
        ax.text(0.98, 0.88, r"L1T Quality $\geq 12$", transform=ax.transAxes,ha='right', va='top', fontsize=22)
