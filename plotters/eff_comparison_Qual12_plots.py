...
WPs = {
    "L1Mu26_12": {"L1": "p^{#mu,L1}_{T} #geq 26", "Reco": "p^{#mu,offline}_{T} #geq 30"},
    "L1Mu22_12": {"L1": "p^{#mu,L1}_{T} #geq 22", "Reco": "p^{#mu,offline}_{T} #geq 26"},
    "L1Mu20_12": {"L1": "p^{#mu,L1}_{T} #geq 20", "Reco": "p^{#mu,offline}_{T} #geq 24"},
    "L1Mu15_12": {"L1": "p^{#mu,L1}_{T} #geq 15", "Reco": "p^{#mu,offline}_{T} #geq 19"},
    "L1Mu10_12": {"L1": "p^{#mu,L1}_{T} #geq 10", "Reco": "p^{#mu,offline}_{T} #geq 14"},
    "L1Mu5_12": {"L1": "p^{#mu,L1}_{T} #geq 5", "Reco": "p^{#mu,offline}_{T} #geq 9"},
    "L1Mu3_12": {"L1": "p^{#mu,L1}_{T} #geq 3", "Reco": "p^{#mu,offline}_{T} #geq 7"}
}
TFs = {
    "uGMT": "|#eta| #leq 2.4",
    "BMTF": "|#eta| #leq 0.83",
...
for var in vars_title:
    for tf in TFs:
        ...
        h_passed_26 = in_file.Get(f"{tf}_L1Mu26_12" + key + "_passed")
        h_passed_26 = utils.add_overflow(h_passed_26)
        h_total_26 = in_file.Get(f"{tf}_L1Mu26_12" + key + "_total")
        ...
        h_passed_20 = in_file.Get(f"{tf}_L1Mu20_12" + key + "_passed")
        h_passed_20 = utils.add_overflow(h_passed_20)
        h_total_20 = in_file.Get(f"{tf}_L1Mu20_12" + key + "_total")
        ...
        h_passed_15 = in_file.Get(f"{tf}_L1Mu15_12" + key + "_passed")
        h_passed_15 = utils.add_overflow(h_passed_15)
        h_total_15 = in_file.Get(f"{tf}_L1Mu15_12" + key + "_total")
        ...
        h_passed_10 = in_file.Get(f"{tf}_L1Mu10_12" + key + "_passed")
        h_passed_10 = utils.add_overflow(h_passed_10)
        h_total_10 = in_file.Get(f"{tf}_L1Mu10_12" + key + "_total")
        ...
        h_passed_5 = in_file.Get(f"{tf}_L1Mu5_12" + key + "_passed")
        h_passed_5 = utils.add_overflow(h_passed_5)
        h_total_5 = in_file.Get(f"{tf}_L1Mu5_12" + key + "_total")
        ...
        h_passed_3 = in_file.Get(f"{tf}_L1Mu3_12" + key + "_passed")
        h_passed_3 = utils.add_overflow(h_passed_3)
        h_total_3 = in_file.Get(f"{tf}_L1Mu3_12" + key + "_total")
        ...
        if var != "eta":
            ...
            latex.DrawLatexNDC(0.65, 0.80, "L1T Quality #geq 12")
            if tf == "uGMT":
            ...
            latex.SetTextSize(0.035)
            latex.DrawLatexNDC(0.6, 0.505, "L1T Quality #geq 12")
