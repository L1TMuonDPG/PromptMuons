...
era_styles = {
    "2025C": {"marker": "o", "label": r"2025C (21.63 $\mathrm{fb}^{-1}$)", "color": "#5790fc"},
    "2025D": {"marker": "s", "label": r"2025D (25.52 $\mathrm{fb}^{-1}$)", "color": "#f89c20"},
    "2025E": {"marker": "^", "label": r"2025E (14.15 $\mathrm{fb}^{-1}$)", "color": "#e42536"},
    "2025F": {"marker": "D", "label": r"2025F (26.89 $\mathrm{fb}^{-1}$)", "color": "#964a8b"},
    "2025G": {"marker": "v", "label": r"2025G (22.40 $\mathrm{fb}^{-1}$)", "color": "#9c9ca1"},
}
...
for tf in track_finders:
    ...
    for wp in WPs:
        ...
        for var in vars_title:
            ...
            if var == "eta":
                ax.set_ylim(0, 1.1)
                utils.add_cms_label(ax, "2025", loc=0, text="Preliminary")
            else:
                ax.set_ylim(0, 1.2)
                utils.add_cms_label(ax, "2025", loc=2, text="Preliminary")
