...
era_styles = {
    ...
    "2026D": {"marker": "s", "label": r"2026D (10.03 $\mathrm{fb}^{-1}$)", "color": "#964a8b"},
}
...
for tf in track_finders:
    ...
    for wp in WPs:
        ...
        for var in vars_title:
            ...
            if var == "eta":
                ax.set_ylim(0, 1.1)
                utils.add_cms_label(ax, "2026All", loc=0, text="Preliminary")
            else:
                ax.set_ylim(0, 1.2)
                utils.add_cms_label(ax, "2026All", loc=2, text="Preliminary")
