...
era_files = {
    #"2025G": ROOT.TFile("/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/nplastir/PromptMuons/2025/files/2025G/eff/merged_total.root", "READ"),
    "2026A": ROOT.TFile("/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/nplastir/PromptMuons/2026/files/2026A/eff/merged_total.root", "READ"),
    "2026B": ROOT.TFile("/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/nplastir/PromptMuons/2026/files/2026B/eff/merged_total.root", "READ"),
    #"2026C": ROOT.TFile("/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/nplastir/PromptMuons/2026/files/2026C/eff/merged_total.root", "READ"),
    "2026D": ROOT.TFile("/eos/cms/store/group/dpg_trigger/comm_trigger/L1Trigger/nplastir/PromptMuons/2026/files/2026D/eff/merged_total.root", "READ"),
}
# Working points
pt_groups = {
...
era_styles = {
    ...
    # "2025D": {"marker": "s", "label": r"2025D (25.29 $\mathrm{fb}^{-1}$)", "color": "#ff7f0e"},#9c9ca1
    ...
    "2026A": {"marker": "^", "label": r"2026A (0.64 $\mathrm{fb}^{-1}$)", "color": "#5790fc"},
    "2026B": {"marker": "o", "label": r"2026B (15.28 $\mathrm{fb}^{-1}$)", "color": "#f89c20"},
    #"2026C": {"marker": "s", "label": r"2026C (2.11 $\mathrm{fb}^{-1}$)", "color": "#e42536"},
    "2026D": {"marker": "s", "label": r"2026D (10.03 $\mathrm{fb}^{-1}$)", "color": "#e42536"},
}
...
for tf in track_finders:
    ...
    for wp in WPs:
        ...
        for var in vars_title:
            ...
            if var == "eta":
                ax.set_ylim(0, 1.1)
                utils.add_cms_label(ax, "2026", loc=0, text="Preliminary")
            else:
                ax.set_ylim(0, 1.2)
                utils.add_cms_label(ax, "2026", loc=2, text="Preliminary")
            ...
            if var == "phi" or var == "eta" or var == "nPV":
                ...
                ax.text(0.62, 0.23, pt_reco_label, transform=ax.transAxes)
            else:
                ax.text(0.62, 0.30, quality_label, transform=ax.transAxes)
                ax.text(0.62, 0.23, pt_l1_label, transform=ax.transAxes)
