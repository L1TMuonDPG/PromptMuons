...
for TF in trig_TF.keys():
  for WP in trig_WP.keys():
    for pt in trg_pt[WP]:
      ...
      h_eff_pt_LowPU_5_7[key] = ROOT.TEfficiency("h_eff_pt_%s_LowPU_5_7" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp)-1, scale_pt)

      h_eff_pt_PU_0_10[key]   = ROOT.TEfficiency("h_eff_pt_%s_PU_0_10" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp)-1, scale_pt)

      h_eff_pt_PU_10_20[key]   = ROOT.TEfficiency("h_eff_pt_%s_PU_10_20" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp)-1, scale_pt)
      h_eff_pt_2_LowPU_5_7[key] = ROOT.TEfficiency("h_eff_pt_2_%s_LowPU_5_7" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp_2)-1, scale_pt_2)

      h_eff_pt_2_PU_0_10[key]   = ROOT.TEfficiency("h_eff_pt_2_%s_PU_0_10" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp_2)-1, scale_pt_2)

      h_eff_pt_2_PU_10_20[key]   = ROOT.TEfficiency("h_eff_pt_2_%s_PU_10_20" % key,
                                                 ";Reco p_{T};Efficiency",
                                                 len(scale_pt_temp_2)-1, scale_pt_2)
      h_eff_pt_2[key] = ROOT.TEfficiency("h_eff_pt_2_%s" % key,";Reco p_{T} [GeV];Efficiency", len(scale_pt_temp_2)-1,  scale_pt_2)
      ...
      h_eff_eta_LowPU_5_7[key] = ROOT.TEfficiency("h_eff_eta_%s_LowPU_5_7" % key,";Reco #eta;Efficiency", eta_bins[0], eta_bins[1], eta_bins[2])
      h_eff_phi_LowPU_5_7[key] = ROOT.TEfficiency("h_eff_phi_%s_LowPU_5_7" % key,";Reco #phi;Efficiency", phi_bins[0], phi_bins[1], phi_bins[2])

      h_eff_eta_PU_0_10[key] = ROOT.TEfficiency("h_eff_eta_%s_PU_0_10" % key,";Reco #eta;Efficiency", eta_bins[0], eta_bins[1], eta_bins[2])
      h_eff_phi_PU_0_10[key] = ROOT.TEfficiency("h_eff_phi_%s_PU_0_10" % key,";Reco #phi;Efficiency", phi_bins[0], phi_bins[1], phi_bins[2])

      h_eff_eta_PU_10_20[key] = ROOT.TEfficiency("h_eff_eta_%s_PU_10_20" % key,";Reco #eta;Efficiency", eta_bins[0], eta_bins[1], eta_bins[2])
      h_eff_phi_PU_10_20[key] = ROOT.TEfficiency("h_eff_phi_%s_PU_10_20" % key,";Reco #phi;Efficiency", phi_bins[0], phi_bins[1], phi_bins[2])
      ...
      h_eff_pt_LowPU_5_7[key].SetDirectory(0)
      h_eff_pt_2_LowPU_5_7[key].SetDirectory(0)
      h_eff_eta_LowPU_5_7[key].SetDirectory(0)
      h_eff_phi_LowPU_5_7[key].SetDirectory(0)

      h_eff_pt_PU_0_10[key].SetDirectory(0)
      h_eff_pt_2_PU_0_10[key].SetDirectory(0)
      h_eff_eta_PU_0_10[key].SetDirectory(0)
      h_eff_phi_PU_0_10[key].SetDirectory(0)

      h_eff_pt_PU_10_20[key].SetDirectory(0)
      h_eff_pt_2_PU_10_20[key].SetDirectory(0)
      h_eff_eta_PU_10_20[key].SetDirectory(0)
      h_eff_phi_PU_10_20[key].SetDirectory(0)
## ================================================
...
for iEvt in range(tree.GetEntries()):
  ...
  run = tree.run
  # if run < 396988: continue
  # if run > 397457: continue
  ...
  is_LowPU_5_7   = (5 <= nPV <= 7)
  is_PU_0_10     = (0 <= nPV <= 10)
  is_PU_10_20     = (10 <= nPV <= 20)
    ...
    for tf in trig_TF:
      ...
      for WP in trig_WP.keys():
        for pt in trg_pt[WP]:
          ...
          if is_LowPU_5_7:
            h_eff_pt_LowPU_5_7[key].Fill(matched, recoPt)
            h_eff_pt_2_LowPU_5_7[key].Fill(matched, recoPt)

          if is_PU_0_10:
            h_eff_pt_PU_0_10[key].Fill(matched, recoPt)
            h_eff_pt_2_PU_0_10[key].Fill(matched, recoPt)

          if is_PU_10_20:
            h_eff_pt_PU_10_20[key].Fill(matched, recoPt)
            h_eff_pt_2_PU_10_20[key].Fill(matched, recoPt)
          if recoPt > pt + 4:
            ...
            if is_LowPU_5_7:
              h_eff_eta_LowPU_5_7[key].Fill(matched, recoEta)
              h_eff_phi_LowPU_5_7[key].Fill(matched, recoPhi)
            if is_PU_0_10:
              h_eff_eta_PU_0_10[key].Fill(matched, recoEta)
              h_eff_phi_PU_0_10[key].Fill(matched, recoPhi)
            if is_PU_10_20:
              h_eff_eta_PU_10_20[key].Fill(matched, recoEta)
              h_eff_phi_PU_10_20[key].Fill(matched, recoPhi)
...
for tf in trig_TF:
  for WP in trig_WP.keys():
    for pt in trg_pt[WP]:
      ...
      # pt2
      h_eff_pt_2_LowPU_5_7[key].Draw()
      h_passed_pt2_LowPU_5_7 = h_eff_pt_2_LowPU_5_7[key].GetPassedHistogram()
      h_passed_pt2_LowPU_5_7.SetName(key + "_pt2_LowPU_5_7_passed")
      h_passed_pt2_LowPU_5_7.Write()
      h_total_pt2_LowPU_5_7 = h_eff_pt_2_LowPU_5_7[key].GetTotalHistogram()
      h_total_pt2_LowPU_5_7.SetName(key + "_pt2_LowPU_5_7_total")
      h_total_pt2_LowPU_5_7.Write()

      # pt
      h_eff_pt_LowPU_5_7[key].Draw()
      h_passed_pt_LowPU_5_7 = h_eff_pt_LowPU_5_7[key].GetPassedHistogram()
      h_passed_pt_LowPU_5_7.SetName(key + "_pt_LowPU_5_7_passed")
      h_passed_pt_LowPU_5_7.Write()
      h_total_pt_LowPU_5_7 = h_eff_pt_LowPU_5_7[key].GetTotalHistogram()
      h_total_pt_LowPU_5_7.SetName(key + "_pt_LowPU_5_7_total")
      h_total_pt_LowPU_5_7.Write()

      # eta
      h_eff_eta_LowPU_5_7[key].Draw()
      h_passed_eta_LowPU_5_7 = h_eff_eta_LowPU_5_7[key].GetPassedHistogram()
      h_passed_eta_LowPU_5_7.SetName(key + "_eta_LowPU_5_7_passed")
      h_passed_eta_LowPU_5_7.Write()
      h_total_eta_LowPU_5_7 = h_eff_eta_LowPU_5_7[key].GetTotalHistogram()
      h_total_eta_LowPU_5_7.SetName(key + "_eta_LowPU_5_7_total")
      h_total_eta_LowPU_5_7.Write()

      # phi
      h_eff_phi_LowPU_5_7[key].Draw()
      h_passed_phi_LowPU_5_7 = h_eff_phi_LowPU_5_7[key].GetPassedHistogram()
      h_passed_phi_LowPU_5_7.SetName(key + "_phi_LowPU_5_7_passed")
      h_passed_phi_LowPU_5_7.Write()
      h_total_phi_LowPU_5_7 = h_eff_phi_LowPU_5_7[key].GetTotalHistogram()
      h_total_phi_LowPU_5_7.SetName(key + "_phi_LowPU_5_7_total")
      h_total_phi_LowPU_5_7.Write()

       # pt2
      h_eff_pt_2_PU_10_20[key].Draw()
      h_passed_pt2_PU_10_20 = h_eff_pt_2_PU_10_20[key].GetPassedHistogram()
      h_passed_pt2_PU_10_20.SetName(key + "_pt2_PU_10_20_passed")
      h_passed_pt2_PU_10_20.Write()
      h_total_pt2_PU_10_20 = h_eff_pt_2_PU_10_20[key].GetTotalHistogram()
      h_total_pt2_PU_10_20.SetName(key + "_pt2_PU_10_20_total")
      h_total_pt2_PU_10_20.Write()

      # pt
      h_eff_pt_PU_10_20[key].Draw()
      h_passed_pt_PU_10_20 = h_eff_pt_PU_10_20[key].GetPassedHistogram()
      h_passed_pt_PU_10_20.SetName(key + "_pt_PU_10_20_passed")
      h_passed_pt_PU_10_20.Write()
      h_total_pt_PU_10_20 = h_eff_pt_PU_10_20[key].GetTotalHistogram()
      h_total_pt_PU_10_20.SetName(key + "_pt_PU_10_20_total")
      h_total_pt_PU_10_20.Write()

      # eta
      h_eff_eta_PU_10_20[key].Draw()
      h_passed_eta_PU_10_20 = h_eff_eta_PU_10_20[key].GetPassedHistogram()
      h_passed_eta_PU_10_20.SetName(key + "_eta_PU_10_20_passed")
      h_passed_eta_PU_10_20.Write()
      h_total_eta_PU_10_20 = h_eff_eta_PU_10_20[key].GetTotalHistogram()
      h_total_eta_PU_10_20.SetName(key + "_eta_PU_10_20_total")
      h_total_eta_PU_10_20.Write()

      # phi
      h_eff_phi_PU_10_20[key].Draw()
      h_passed_phi_PU_10_20 = h_eff_phi_PU_10_20[key].GetPassedHistogram()
      h_passed_phi_PU_10_20.SetName(key + "_phi_PU_10_20_passed")
      h_passed_phi_PU_10_20.Write()
      h_total_phi_PU_10_20 = h_eff_phi_PU_10_20[key].GetTotalHistogram()
      h_total_phi_PU_10_20.SetName(key + "_phi_PU_10_20_total")
      h_total_phi_PU_10_20.Write()

       # pt2
      h_eff_pt_2_PU_0_10[key].Draw()
      h_passed_pt2_PU_0_10 = h_eff_pt_2_PU_0_10[key].GetPassedHistogram()
      h_passed_pt2_PU_0_10.SetName(key + "_pt2_PU_0_10_passed")
      h_passed_pt2_PU_0_10.Write()
      h_total_pt2_PU_0_10 = h_eff_pt_2_PU_0_10[key].GetTotalHistogram()
      h_total_pt2_PU_0_10.SetName(key + "_pt2_PU_0_10_total")
      h_total_pt2_PU_0_10.Write()

      # pt
      h_eff_pt_PU_0_10[key].Draw()
      h_passed_pt_PU_0_10 = h_eff_pt_PU_0_10[key].GetPassedHistogram()
      h_passed_pt_PU_0_10.SetName(key + "_pt_PU_0_10_passed")
      h_passed_pt_PU_0_10.Write()
      h_total_pt_PU_0_10 = h_eff_pt_PU_0_10[key].GetTotalHistogram()
      h_total_pt_PU_0_10.SetName(key + "_pt_PU_0_10_total")
      h_total_pt_PU_0_10.Write()

      # eta
      h_eff_eta_PU_0_10[key].Draw()
      h_passed_eta_PU_0_10 = h_eff_eta_PU_0_10[key].GetPassedHistogram()
      h_passed_eta_PU_0_10.SetName(key + "_eta_PU_0_10_passed")
      h_passed_eta_PU_0_10.Write()
      h_total_eta_PU_0_10 = h_eff_eta_PU_0_10[key].GetTotalHistogram()
      h_total_eta_PU_0_10.SetName(key + "_eta_PU_0_10_total")
      h_total_eta_PU_0_10.Write()

      # phi
      h_eff_phi_PU_0_10[key].Draw()
      h_passed_phi_PU_0_10 = h_eff_phi_PU_0_10[key].GetPassedHistogram()
      h_passed_phi_PU_0_10.SetName(key + "_phi_PU_0_10_passed")
      h_passed_phi_PU_0_10.Write()
      h_total_phi_PU_0_10 = h_eff_phi_PU_0_10[key].GetTotalHistogram()
      h_total_phi_PU_0_10.SetName(key + "_phi_PU_0_10_total")
      h_total_phi_PU_0_10.Write()
out_file.Write()